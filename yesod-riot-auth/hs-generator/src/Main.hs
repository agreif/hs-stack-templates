          ...
          [ BCrudModel
            ...
            BCrudModel
              { bCrudModelName = "demoa",
                ...
                bCrudModelEditFormEntityLoader = Nothing,
                bCrudModelDeleteFormEntityLoader = Nothing,
                bCrudModelAddFormDataJsonUrl = Just "BackendR DemoaListDataR",
                bCrudModelEditFormDataJsonUrl = Just "BackendR DemoaListDataR",
                bCrudModelDeleteFormDataJsonUrl = Just "BackendR DemoaListDataR",
                bCrudModelAddFormHasDefaultModel = False,
                bCrudModelEditPostLoadsModel = False,
                bCrudModelDeletePostLoadsModel = False,
                bCrudModelAddPostExtraStoreFunc = Nothing,
                ...
                bCrudModelParentHsType = Nothing,
                bCrudModelFormRouteHsType = "BackendR",
                bCrudModelFields =
                  [ BCrudField
            ...
            BCrudModel
              { bCrudModelName = "demob",
                ...
                bCrudModelEditFormEntityLoader = Nothing,
                bCrudModelDeleteFormEntityLoader = Nothing,
                bCrudModelAddFormDataJsonUrl = Just "BackendR DemobListDataR",
                bCrudModelEditFormDataJsonUrl = Just "BackendR $ DemobDetailDataR demobId",
                bCrudModelDeleteFormDataJsonUrl = Just "BackendR DemobListDataR",
                bCrudModelAddFormHasDefaultModel = False,
                bCrudModelEditPostLoadsModel = False,
                bCrudModelDeletePostLoadsModel = False,
                bCrudModelAddPostExtraStoreFunc = Nothing,
            ...
            BCrudModel
              { bCrudModelName = "democ",
                ...
                bCrudModelEditFormEntityLoader = Nothing,
                bCrudModelDeleteFormEntityLoader = Nothing,
                bCrudModelAddFormDataJsonUrl = Just "BackendR $ DemobDetailDataR demobId",
                bCrudModelEditFormDataJsonUrl = Just "BackendR $ DemobDetailDataR $ democDemobId democ",
                bCrudModelDeleteFormDataJsonUrl = Just "BackendR $ DemobDetailDataR $ democDemobId democ",
                bCrudModelAddFormHasDefaultModel = False,
